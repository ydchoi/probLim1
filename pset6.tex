...
= 1 - \mathbb{P}(|n^{-1}X_1| \leq \epsilon)^n \\
&=& 1 - (1 -\mathbb{P}(|n^{-1}X_1| >
\epsilon)^n = 1 - e^{-n\mathbb{P}(|X_1| > n\epsilon)} 
\eQe
for any $\epsilon > 0$ and $n \geq 1$. Hence, by convergence in probability,
with $\epsilon = 1$,
\eQb
n\mathbb{P}(|X_1| > \epsilon ) \to 0 
\eQe
so 
\eQb
n\mathbb{P}(|X_1| > \epsilon ) \to 0 
