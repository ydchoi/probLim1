...
$q$ to achieve this) 
\eQb
\lim_{p \downarrow 0} \dfrac{(\mathbb{E}X^p -1)}{p} &=&
\lim_{p \downarrow 0} 
\mathbb{E}[\dfrac{X^p-1}{p} 1_{\{X \geq 1\}}] + \mathbb{E}[
\dfrac{X^p-1}{p}1_{\{X < 1\}}] \\
&=& \mathbb{E}[\log(X)1_{\{X \geq 1\}}] + \mathbb{E}[\log(X)1_{\{X < 1\}}] \\
&=& \mathbb{E}[\log(X)],
\eQe 
as required. \hfill $\qed$
